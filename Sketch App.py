...
class Sketch:
    def __init__(self, root):
        ...
        self.window = root
        self.window.title("Sketch App" + "-----" + "New Window")
    ...
    def controller(self):
        ...
        self.line_img = ImageTk.PhotoImage(Image.open("Pictures/line.jpg").resize((20, 20), PIL.Image.LANCZOS))
        ...
        self.das_img = ImageTk.PhotoImage(Image.open("Pictures/dashed_line.png").resize((20, 20), PIL.Image.LANCZOS))
        ...
        self.rectangle_img = ImageTk.PhotoImage(Image.open("Pictures/rectangle.jpg").resize((20, 20), PIL.Image.LANCZOS))
        ...
        self.parallelogram_img = ImageTk.PhotoImage(Image.open("Pictures/parallelogram.png").resize((20, 20), PIL.Image.LANCZOS))
        ...
        self.traingle_img = ImageTk.PhotoImage(Image.open("Pictures/traingle.jpg").resize((20, 20), PIL.Image.LANCZOS))
        ...
        self.pentagon_img = ImageTk.PhotoImage(Image.open("Pictures/pentagon.png").resize((20, 20), PIL.Image.LANCZOS))
        ...
        self.hexagon_img = ImageTk.PhotoImage(Image.open("Pictures/hexagon.png").resize((20, 20), PIL.Image.LANCZOS))
        ...
        self.arrow_img = ImageTk.PhotoImage(Image.open("Pictures/arrow.png").resize((20, 20), PIL.Image.LANCZOS))
        ...
        self.circle_img = ImageTk.PhotoImage(Image.open("Pictures/circle.png").resize((20, 20), PIL.Image.LANCZOS))
        ...
        self.right_angled_traingle_img = ImageTk.PhotoImage(Image.open("Pictures/right_angled_traingle.png").resize((20, 20), PIL.Image.LANCZOS))
        ...
        self.rounded_rec_img = ImageTk.PhotoImage(Image.open("Pictures/rounded_rectangle.png").resize((20, 20), PIL.Image.LANCZOS))
        ...
        self.arrow_left_img = ImageTk.PhotoImage(Image.open("Pictures/left_arrow.png").resize((20, 20), PIL.Image.LANCZOS))
        ...
        self.pencil_img = ImageTk.PhotoImage(Image.open("Pictures/pencil.png").resize((17, 17), PIL.Image.LANCZOS))
        ...
        self.eraser_img = ImageTk.PhotoImage(Image.open("Pictures/eraser.png").resize((17, 17), PIL.Image.LANCZOS))
        ...
        self.text_img = ImageTk.PhotoImage(Image.open("Pictures/text_pic.png").resize((17, 17), PIL.Image.LANCZOS))
        ...
        self.selection_img = ImageTk.PhotoImage(Image.open("Pictures/selection_box.png").resize((17, 17), PIL.Image.LANCZOS))
        ...
        self.color_box_img = ImageTk.PhotoImage(Image.open("Pictures/color_conatiner.png").resize((17, 17), PIL.Image.LANCZOS))
    ...
    def make_menu(self):
        ...
        for i in range(17):
            ...
            self.menu_img_container[i] = ImageTk.PhotoImage(
                Image.open("Pictures/" + menu_img[i]).resize((30, 30), PIL.Image.LANCZOS))
    ...
    def color_set(self):#Color set from colorbox
        ...
        for i in range(15):
            ...
            self.color_container[i] = ImageTk.PhotoImage(Image.open("Pictures/" + color_storage[i]).resize((15, 15), PIL.Image.LANCZOS))
    ...
    def set_permanent_choose_color(self):#Set permanent color: border and background
        ...
        self.choosing_color = ImageTk.PhotoImage(Image.open("Pictures/choose_color.png").resize((15, 15), PIL.Image.LANCZOS))
    ...
    def about(self):#About under Help menu
        ...
        self.about_img[0] = ImageTk.PhotoImage(Image.open("Pictures/Shapes_and_lines_box.png").resize((200,160),PIL.Image.LANCZOS))
        self.about_img[1] = ImageTk.PhotoImage(Image.open("Pictures/Tools_collection.png").resize((200, 100), PIL.Image.LANCZOS))
        self.about_img[2] = ImageTk.PhotoImage(Image.open("Pictures/width_controller.png").resize((140, 160), PIL.Image.LANCZOS))
        self.about_img[3] = ImageTk.PhotoImage(Image.open("Pictures/Notation_box.png").resize((30, 150), PIL.Image.LANCZOS))
        self.about_img[4] = ImageTk.PhotoImage(Image.open("Pictures/Color_segment.png").resize((200, 140), PIL.Image.LANCZOS))
    ...
    def tips(self):#Tips under Help menu
        ...
        self.about_img[0] = ImageTk.PhotoImage(Image.open("Pictures/line.jpg").resize((20, 20), PIL.Image.LANCZOS))
